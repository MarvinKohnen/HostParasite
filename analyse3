...
adf = adf[1]
close(io)
CSV.write("dataGrazerCopepodPhytoPlanktonSticklebackParasite.csv", adf)




# Load the CSV file
adf = CSV.File("dataGrazerCopepodPhytoPlanktonSticklebackParasite.csv") |> DataFrame
...
traces=[
    ...
    scatter(
        name = "Infected Copepod ",
        x=x,
        y=adf.count_copepodInf,
        line=attr(color="rgb(70,70,52)"),
        mode="lines"
    )
]
layout = Layout(
